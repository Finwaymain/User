          ...
          if (hasAssignedDriver &&
            ...
            try {
              dynamic durationResponse = await dio.get(
                  "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=${parcelData!.latSource},${parcelData!.lngSource}&destinations=$dLat,$dLng&key=${Constant.kGoogleApiKey}");
            ...
            if (mounted) {
              setState(() {
                ...
                _markers[parcelData!.id.toString()] = Marker(
                    ...
                    infoWindow: InfoWindow(title: parcelData!.driverName ?? "Delivery Partner"),
            ...
            if (_markers.containsKey(parcelData!.id.toString())) {
              setState(() {
                _markers.remove(parcelData!.id.toString());
              });
            }
          }
        }
