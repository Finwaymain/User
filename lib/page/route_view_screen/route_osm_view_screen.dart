    ...
    _driverLocationSubscription = FirebaseDatabase.instance
      ...
      try {
        ...
        if (latStr != null && latStr.isNotEmpty && lngStr != null && lngStr.isNotEmpty) {
          double dLat = double.parse(latStr);
          double dLng = double.parse(lngStr);
        ...
        print("Error listening to driver RTDB: $e");
      }
    });
  }
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  // Action buttons row (Chat, Share, Active Call)
                                  Row(
                                    children: [
                                      if (rideData!.statut == "confirmed") ...[
                                        InkWell(
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            child: SvgPicture.asset(
                                              ...
                                              width: 18,
                                              colorFilter: ColorFilter.mode(
                                                themeChange.getThem() ? AppThemeData.surface50Dark : AppThemeData.secondary200,
                                                BlendMode.srcIn,
                                              ),
                                            ),
                                          ),
