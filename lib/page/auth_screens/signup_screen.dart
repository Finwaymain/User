...
import 'package:finway/controller/sign_up_controller.dart';
import 'package:finway/page/auth_screens/login_screen.dart';
import 'package:finway/page/auth_screens/signup_success_screen.dart';
import 'package:finway/themes/button_them.dart';
import 'package:finway/themes/constant_colors.dart';
import 'package:finway/themes/text_field_them.dart';
import 'package:finway/utils/Preferences.dart';
import 'package:finway/utils/dark_theme_provider.dart';
import 'package:finway/widget/permission_dialog.dart';
                                    ...
                                    children: [
                                      ...
                                      Container(
                                          ...
                                          child: IntlPhoneField(
                                            ...
                                            readOnly: controller.loginType.value == "google" || controller.loginType.value == "apple" ? true : false,
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                recognizer: TapGestureRecognizer()
                                  ..onTap = () => Get.offAll(LoginScreen(), duration: const Duration(milliseconds: 400), transition: Transition.rightToLeft),
                                text: 'Login'.tr,
                                style: TextStyle(
                                  fontSize: 16,
                                  fontFamily: AppThemeData.medium,
