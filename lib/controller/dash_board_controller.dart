...
class DashBoardController extends GetxController {
  ...
  onSelectItem(int index,bool isLogin) async {
    ...
    if (item.title == 'Wallet'.tr || item.title == 'Smart Value'.tr) {
      ...
      try {
        final Uri marketUri = Uri.parse("market://details?id=com.fiinway");
        final Uri playStoreUri = Uri.parse("https://play.google.com/store/apps/details?id=com.fiinway");
        ...
        try {
          final Uri fallbackUri = Uri.parse("https://play.google.com/store/apps/details?id=com.fiinway");
