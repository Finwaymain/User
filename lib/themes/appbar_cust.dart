...
class CustomAppbar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
        backgroundColor:  bgColor ?? (isDark ? AppThemeData.grey800 : Colors.white),
        ...
        title: Text(
          ...
          style: TextStyle(
            ...
            color: textColor ?? (isDark ? AppThemeData.grey900Dark : AppThemeData.grey900),
          ),
        ),
                    ...
                    icon: Transform(
                      ...
                      child: SvgPicture.asset(
                        ...
                        colorFilter: ColorFilter.mode(
                          textColor ?? (isDark ? AppThemeData.grey900Dark : AppThemeData.grey900),
                          BlendMode.srcIn,
                        ),
                      ),
                    ))
